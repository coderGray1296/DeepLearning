...
# Data Preparation
print('Loading data...')
x_train, y_train = data_helper.load_data('../data/UCI/train_ccpp_new.txt')
x_test, y_test = data_helper.load_data('../data/UCI/test_ccpp_new.txt')
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # print(losses)
        model_saver.save(sess, '../checkpoint_ccpp/result.ckpt', global_step=global_step)
        ...
        '''
        ckpt = tf.train.get_checkpoint_state("../checkpoint_ccpp/")
        ...
        np.savetxt('../data/UCI/test_ccpp_picked.txt', new_data)
